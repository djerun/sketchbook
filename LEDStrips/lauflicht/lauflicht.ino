...
void rainbow() {
  ...
  for (int i = 0; i < NUM_LEDS; ++i) {
    leds[i] = CHSV((state+(i*255/64 /*NUM_LEDS*/))%256, 255, 255); //with NUM_LEDS == 150 dividing by little more than 64 bugges out on high values of i
  }
  FastLED.show();
}
